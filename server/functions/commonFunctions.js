...
exports.getGeneralInfo = async (req, res, type, fromNode = false) => {
    ...
    if((!req.appSettings['payment_qpay_method'] || req.appSettings['payment_qpay_method'] == 1) && req.appSettings['payment_qpay_username'] && req.appSettings['payment_qpay_password']){
    ...
    if (req.user) {
        ...
        req.query.firstTimeDiscount = 0;

        if(await transactionModel.checkFirstTimePackage(req)){
            req.query.firstTimeDiscount = process.env.FIRST_TIME_DISCOUNT;
        }
