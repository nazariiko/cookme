...
if(process.env.JAWSDB_URL){
 ...
 data = data.split(":");
 const dataPassHost = data[1].split("@");
 const dataPortDb = data[2].split("/");
}
/*
...
*/
// handle unhandled rejections with pino logger
process.on('unhandledRejection', (error, p) => {
...
registerI18n(server, (t, error) => {
  app
    ...
    server.use(function (req, res, next) {
      ...
      if (req.url.toLowerCase().match(".js|.css|.woff|.jpg|.png|.gif|.ttf|.jpeg|.mp4|.m3u8|.avif")) {
