...
exports.castncrew = async (req, res) => {
    ...
    const url = req.originalUrl.replace(process.env.ADMIN_SLUG, '');
    res.render("admin/movies/cast-crew", { imageSuffix: imageSuffix,paggingData:paggingData,totalCount:totalCount, results: results, title: "Manage Cast & Crew Members", nav: url })
