...
const Layout = React.memo((props) => {
    ...
    let videoDuration = ""
    let videoURL = ""
    // imageSuffix variable based on the existence of props.pageData.imageSuffix. If it exists, use it as is. Otherwise, set it to an empty string.
    let imageSuffix = props.pageData.imageSuffix || ''
    ...
    return (
        <React.Fragment>
            ...
            <Script src="//googleads.github.io/videojs-ima/node_modules/video.js/dist/video.min.js" strategy="beforeInteractive"></Script>

            {
                ...
                <React.Fragment>
                    ...
                    <Script src="//googleads.github.io/videojs-ima/node_modules/videojs-contrib-ads/dist/videojs.ads.min.js" strategy="beforeInteractive" />
                    <Script src="//googleads.github.io/videojs-ima/dist/videojs.ima.js" strategy="beforeInteractive" />
                </React.Fragment>
                : null
            }
