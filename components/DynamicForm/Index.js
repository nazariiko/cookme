...
const DynamicForm = (props) => {
  ...
  //     values.fields =  { ...props.defaultValues }
  //   if (props.videoKey)
  //     values.videoKey = props.videoKey
  //   if (props.defaultValues && props.defaultValues.tags)
  //     values.tags = props.defaultValues.tags
  ...
  // useEffect(() => {
  //   if(props.defaultValues.tags != state.tags)
  //     setState({tags:props.defaultValues.tags ?? []})
  // },[props.tags])
  ...
  const removeTag = (i) => {
    ...
    newTags.splice(i, 1);
    setState({ fields: {...fields, tags: newTags} });
  }
