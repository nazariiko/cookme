                            ...
                            !state.otpEnable ? 
                                <React.Fragment>
                                    <div className="input-group">
                                        <input className="form-control" type="text" onChange={onChange.bind(this,'email')} autoComplete="off" readOnly={isReadonly} onClick={e => setIsReadonly(false)} value={state.email} placeholder={Translate(props,"Email / Username")} name="email" />
                                    </div>
                                    <div className="input-group">
                                        <input className="form-control" autoComplete="off" type="password" onChange={onChange.bind(this,'password')} value={state.password} placeholder={Translate(props,"Password")}
                                            name="password" />
                        ...
                        <React.Fragment>
                            {
                                !state.passwordEnable ? 
                                    state.type == "email" ?
                                        <div className="input-group">
                                            <input className="form-control" type="text" onChange={onChange.bind(this,'email')} value={state.email} placeholder={Translate(props,"Email / Username")} readOnly={isReadonly} onClick={e => setIsReadonly(false)} name="email" />
                                        </div>
                                        :
                                        <div className="input-group">                                            
                                            <PhoneInput
