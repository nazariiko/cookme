...
const Index = (props) => {
    ...
    return () => {
      ...
      if (
        ...
        if (state.playlistVideos) {
          ...
          props.updatePlayerData({relatedVideos:[],playlistVideos:videos,currentVideo:video,deleteMessage:deleteMessage,deleteTitle:deleteTitle,liveStreamingURL:props.pageData.liveStreamingURL})
          ...
          props.updatePlayerData({relatedVideos:videos,playlistVideos:[],currentVideo:video,deleteMessage:deleteMessage,deleteTitle:deleteTitle,liveStreamingURL:props.pageData.liveStreamingURL})

        } else {
          let video = stateRef.current;
          video.playerElem = props.pageData.appSettings["player_type"];
          props.updatePlayerData({relatedVideos:[],playlistVideos:[],currentVideo:video,deleteMessage:deleteMessage,deleteTitle:deleteTitle,liveStreamingURL:props.pageData.liveStreamingURL})
        }
      } else if (reduxState.audio.song_id)
  ...
  const openReport = (e) => {
    ...
    if (props.pageData && !props.pageData.loggedInUserDetails) {
      ...
      props.openReport({status:true, id:state.video.custom_url, type:"videos"});
    }
  };
  const downloadBtn = (e) => {
    e.preventDefault();
  ...
  let videoImage = state.video ? state.video.image : "";
                      ...
                      <div className="videoDetailsWrap-content">
                        ...
                        <div className="details-tab">
                          ...
                          >
                            ...
                            {state.video && state.video.donors &&
                            ...
                            {state.video && state.video.artists &&
                            ...
                            {props.pageData.appSettings[`${"video_comment"}`] ==
                              1 && state.video && state.video.approve == 1 ? (
                              <li className="nav-item">
                                <a
                                  className={`nav-link${
                              ...
                              >
                                <div className="details-tab-box">
                                  <Members
                                    ...
                                    globalSearch={true}
                                    channel_members={
                                      state.video.donors.results
                                    }
                                    channel_pagging={
                                      state.video.donors.pagging
                                    }
                              ...
                              >
                                <div className="details-tab-box">
                                  <Artists
                                    ...
                                    {...props}
                                    artists={
                                      state.video.artists.results
                                    }
                                    pagging={
                                      state.video.artists.pagging
                                    }
                                    video_id={state.video.video_id}
                                  />
                                </div>
