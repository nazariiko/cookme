...
const MiniPlayer = (props) => {
  ...
  const [state, setState] = useReducer(
    ...
    {
      relatedVideos: menuOpen.relatedVideos ?? [],
      playlistVideos: menuOpen.playlistVideos ?? [],
      currentVideoTime: menuOpen.currentVideoTime,
      video: menuOpen.currentVideo,
      arrow: "up",
      message: menuOpen.deleteMessage,
      title: menuOpen.deleteTitle,
      liveStreamingURL: menuOpen.liveStreamingURL,
  ...
  useEffect(() => {
    if (
      menuOpen.relatedVideos != state.relatedVideos ||
      menuOpen.playlistVideos != state.playlistVideos ||
      menuOpen.currentVideoTime != state.currentVideoTime ||
      menuOpen.currentVideo != state.currentVideo
    ) {
      setState({
        message: menuOpen.deleteMessage,
        title: menuOpen.deleteTitle,
