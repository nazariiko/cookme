...
const Index = (props) => {
    ...
    const submitForm = async () => {
        ...
        if(props.pageData.appSettings["recaptcha_enable"] == 1 && props.pageData.appSettings["recaptcha_contactus_enable"] == 1){
    ...
    const setToken = (token) => {
        if(state.firstToken){
            setState({captchaToken:token,getCaptchaToken:false,firstToken:false});
        }else{
            ...
            <React.Fragment>
                    <div className="titleBarTop">
                        <div className="titleBarTopBg">
                            <img src={props.pageData['pageInfo']['banner'] ? props.pageData.imageSuffix+props.pageData['pageInfo']['banner'] : props.pageData['subFolder']+"static/images/breadcumb-bg.jpg"} alt={props.t("Contact Us")} />
                        </div>
                                        ...
                                        <div className="contact-area">
                                            {
                                                props.pageData.appSettings['contact_map'] ?
                                                    <div className="gmap">
                                                        <iframe src={props.pageData.appSettings['contact_map']} width="100%" height="500" frameBorder="0" style={{ border: "0" }} allowFullScreen></iframe>
                                                    </div>
                                                    : null
                                            }
                                            <div className="container">
                                                <div className="row">
                                                                ...
                                                                <div className="row">
                                                                    <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                                                                        <div className="cf-input-box">
                                                                            <input type="text" placeholder={props.t("Name")} value={state.fields.name} onChange={change} id="name" name="name" required="" />
                                                                            {
                                                                                state.errors.name ?
                                                                    ...
                                                                    <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                                                                        <div className="cf-input-box">
                                                                            <input type="email" placeholder={props.t("Email")} value={state.fields.email} onChange={change} id="email" name="email" required="" />
                                                                            {
                                                                                state.errors.email ?
                                                                    ...
                                                                    <div className="col-12">
                                                                        <div className="cf-input-box">
                                                                            <input type="text" placeholder={props.t("Subject")} value={state.fields.subject} onChange={change} id="subject" name="subject" required="" />
                                                                            {
                                                                                state.errors.subject ?
                                                                                    <p className="error">{state.errors.subject}</p>
                                                                                    : null
                                                                            }
                                                                        </div>
                                                                    </div>
                                                                    <div className="col-12">
                                                                        <div className="cf-input-box">
                                                                            <textarea className="contact-textarea" placeholder={props.t("Message")} value={state.fields.message} id="message" name="message" onChange={change} required=""></textarea>
                                                                            {
                                                                    ...
                                                                    <div className="col-12">
                                                                        <div className="cf-input-box">
                                                                            <button id="submit" className="cont-submit btn-contact" name="submit">{props.t(state.submitting ? "Submitting..." : "Submit")}</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                    ...
                                                    <div className="col-md-5 offset-lg-1">
                                                        {
                                                            props.pageData.appSettings['contact_address'] || props.pageData.appSettings['contact_phone'] || props.pageData.appSettings['contact_fax'] || props.pageData.appSettings['contact_email'] ?
                                                                <div className="contact-info">
                                                                    <h4 className="contact-title">{props.t("Address")}</h4>
                                                                    <ul className="info">
                                                                        {
                                                                            props.pageData.appSettings['contact_address'] ?
                                                                                <li><span className="material-icons">
                                                                                room
                                                                                </span> <span>{props.pageData.appSettings['contact_address']}</span></li>
                                                                                : null
                                                                        }
                                                                        {
