...
const Password = (props) => {
    ...
    const onSubmit = async model => {
        ...
        formFields.push(
            ...
            { key: "price", props: { readOnly: state.plan ? true : false }, label: `Price Monthly (${props.pageData.appSettings.payment_default_currency})`,type:"text" ,isRequired:true,value:state.plan ? state.plan.price.toString() : ""},
            {
                key: "res_type_1",
                type: "content",
