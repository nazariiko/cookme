                                    ...
                                    <div id={`collapse${season.season_id}`} className={`collapse${index == 0 ? " show" : ""}`} aria-labelledby={`heading${season.season_id}`} data-parent="#seasonData">
                                        <div className="season_cnt">
                                            <ul className="season_selection nav justify-content-center">
                                                {
                                                    !state.fromCastnCrew ? 
                                                <li className={!state.selectedTabs[season.season_id] || state.selectedTabs[season.season_id] == "episode" ? "active" : "nav-link"} onClick={() => {selectedtab("episode",season.season_id)}}>
                                                    {
                                                        props.t("Episodes")
                                                    }
                                                </li>
                                                ...
                                                <li className={state.selectedTabs && state.selectedTabs[season.season_id] == "cast" ? "active" : "nav-link"} onClick={(e) => {selectedtab("cast",season.season_id)}}>
                                                    {
                                                        props.t("Regular Cast")
                                                    }
                                                </li>
                                                <li className={state.selectedTabs && state.selectedTabs[season.season_id] == "crew" ? "active" : "nav-link"} onClick={(e) => {selectedtab("crew",season.season_id)}}>
                                                    {
