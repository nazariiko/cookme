        ...
        axios.post(url, formData, config)
            .then(response => {
                if (response.data.error) {
                    ...
                    setState({percentCompleted:0,processing:false, videoWidth: response.data.videoWidth, validating: false, id: response.data.id, success: true, videoTitle: response.data.name, videoImage: response.data.images[0] });
