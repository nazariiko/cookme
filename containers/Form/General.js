...
const General = (props) => {
    ...
    const handleOTPChange = (value) => {
        ...
        if (props.pageData.appSettings['whitelist_domain'] == 1) {
            formFields.push({ key: "whitelist_domain", type:"textarea", label: "Whitelist Domain for Privacy(enter comman seprated domain name only eg:www.xyz.com)", value: state.member.whitelist_domain })
        }
        formFields.push({
            key: "search",
            label: "",
