  ...
  const selectedPackage = (package_id, price, subscriptionPayment, e) => {
    ...
    if (
      ...
      setState({
        ...
        gatewayPrice: Math.max(price - props.pageData.firstTimeDiscount, 0),
                    ...
                    <thead>
                      <tr className="upgrade-header">
                        <th className="infoprice">
                          {props.pageData.firstTimeDiscount > 0 &&
                            <h4 className="text-danger"> {Translate(props, `You have $`) + props.pageData.firstTimeDiscount + Translate(props, ` discount for first purchase!`)}</h4>
                          }
                        ...
                        {state.packages.map((result) => {                         
                          return (
                            ...
                            >
                              ...
                              <div className="price-now flex-column">
                                  {props.pageData.firstTimeDiscount > 0 && 
                                           <>
                                              <h6 className="text-danger">{props.t("ReferallHeroDiscount")}</h6>
                                              <s className="me-4"><Currency {...props} {...result} /></s>
                                           </>
                                  }
                                  <h5> <Currency {...props} {...result} {...{price: Math.max(result.price - props.pageData.firstTimeDiscount, 0)}}/></h5>
