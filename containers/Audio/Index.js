...
const Index = (props) => {
  ...
  const playSong = (song_id, audio, e) => {
    ...
    let audios = reduxState.audio.audios;
  ...
  const playPauseSong = (song_id, audio, e) => {
    ...
    if (
      reduxState.audio.song_id == 0 ||
      song_id == reduxState.audio.pausesong_id ||
  ...
  const openReport = (e) => {
    ...
    if (props.pageData && !props.pageData.loggedInUserDetails) {
      ...
      props.openReport({status:true, id:state.audio.custom_url, type:"audio"});
    }
  };
                    ...
                    <div className="infoPlay-innr">
                      <div className="miniplay">
                        ...
                        {!state.needSubscription ? (
                          reduxState.audio.song_id != state.audio.audio_id ||
                          reduxState.audio.pausesong_id == state.audio.audio_id ? (
                            <div
                              className="playbtn"
                              onClick={(e) => playSong(
                    ...
                    <div key={audio.audio_id} className="sidevideoWrapOutr">
                      ...
                      >
                        <div className="videoList_thumb">
                          ...
                          {reduxState.audio.song_id != audio.audio_id ||
